...
export const SEASONOFGHOSTS = [
    ...
    new Event(tag,"The party returned from an errand for Ren Mei Li and learned that Kazumo Oono, Kubo's father, had been murdered<br><br>They discovered signs of a supernatural attack during their investigation of the murder scene",4724,3,9),
    ...
    new Event(tag,"Ren Mei Li officially offered the party positions as her stewards once they have completed her final task; Kubo and Yoonji accepted",4724,3,20),
    ...
    new Event(tag,"While on overnight watch, Kubo witnessed a figure return to the Governor's Manor<br><br>They discovered the body of You So-Jin in her workshop in the morning",4724,3,24),
    ...
    new Event(tag,"The party passed through an alternate version of the governor's manor and through the door they saw in the Path Maiden's answer.<br><br>In Kugaptee's Dream, they freed the souls of those killed by the corrupted Heh Shan-Bao<br><br>They continued into Kugaptee's Grave and freed the Governor's soul, stopping Kugaptee from returning",4724,3,28)
]